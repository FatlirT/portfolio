    ...
    return (
        <>
            <div className="relative overflow-hidden w-full max-w-3xl h-72 mx-auto rounded-3xl border-2 border-light-acc/35 bg-black/5 shadow-[inset_0_0px_20px_rgba(0,0,0,0.2)]">
                ...
                <button
                    className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-light-acc bg-opacity-50 text-white p-2 rounded-full z-10 text-center w-11 sm:block hidden"
                    onClick={prevImage}
                >
                    &lt;
                </button>
                <button
                    className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-light-acc bg-opacity-50 text-white p-2 rounded-full z-10 text-center w-11 sm:block hidden"
                    onClick={nextImage}
                >
                    &gt;
                </button>
