...
const ProjectCard = ({ name, description, imageUrls, tech, wip, soureCodeUrl, url }: props) => {
    return (
        <>
            <div id="project-card-main" className="w-full max-w-full overflow-clip text-wrap shadow-lg shadow-dark-acc/30 bg-light-acc/35 rounded-3xl p-8 text-xl relative flex flex-col items-center text-center justify-center space-y-6 space-y-reverse">
