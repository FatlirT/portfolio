    ...
    return (
        ...
        <form className='w-full'>
            ...
            <div className="overflow-hidden w-full justify-between flex flex-row text-sm rounded-lg bg-light-acc/10 focus:ring:none py-2 px-3">
                ...
                <input id="default-search" className="w-full overflow-scroll text-sm text-white rounded-lg bg-transparent outline-none ring-0 focus:ring-0 focus:outline-none border-none placeholder-white sm:mx-3 mx-2" placeholder="Search Articles" required />
