...
const Toggle = ({ onClick, mode, defOption, altOption }: { onClick: Function; mode: string | undefined; defOption: Option; altOption: Option; }) => {
    ...
    return (
        ...
        <div onClick={handleToggleClick} className="hover:cursor-pointer hover:bg-dark-acc/20 active:bg-dark-acc/70 active:border-2 active:border-white border-2 border-transparent toggle-container bg-dark-acc/50 px-3 py-2 text-sm font-medium flex w-fit">
